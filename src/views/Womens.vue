...
<template>
  <div>
    ...
    <div v-else>
      <div
        :style="{
          'background': 'linear-gradient(#FDE2FF, #FDE2FF) 0% 0% / 100% 50%, white 0% 50% / 100% 50%',
          'height': '70vh'
        }"
        class="container"
      >
...
export default {
  ...
  methods: {
    nextProduct() {
      if (this.currentProductIndex < this.womenProducts.length - 1) {
    ...
    showProductDetails() {
      ...
      this.product = this.womenProducts[this.currentProductIndex];
